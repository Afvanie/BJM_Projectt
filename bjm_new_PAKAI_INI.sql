...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Des 2022 pada 00.02
...
--
-- Ketidakleluasaan untuk tabel `rulediagnosas`
--
ALTER TABLE `rulediagnosas`
  ADD CONSTRAINT `rulediagnosas_gejalas_id_foreign` FOREIGN KEY (`gejalas_id`) REFERENCES `gejalas` (`id`),
  ADD CONSTRAINT `rulediagnosas_indikatorbobots_id_foreign` FOREIGN KEY (`indikatorbobots_id`) REFERENCES `indikatorbobots` (`id`),
  ADD CONSTRAINT `rulediagnosas_penyakits_id_foreign` FOREIGN KEY (`penyakits_id`) REFERENCES `penyakits` (`id`);
